...
var $create = function create$$1(O, Properties) {
...
// For preventing possible almost infinite loop in non-standard implementations, test the forward version of the method
var USES_TO_LENGTH$10 = arrayMethodUsesToLength('reduce', { 1: 0 });

// `Array.prototype.reduceRight` method
// https://tc39.github.io/ecma262/#sec-array.prototype.reduceright
_export({ target: 'Array', proto: true, forced: !STRICT_METHOD$6 || !USES_TO_LENGTH$10 }, {
...
var USES_TO_LENGTH$11 = arrayMethodUsesToLength('slice', { ACCESSORS: true, 0: 0, 1: 2 });
...
_export({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$2 || !USES_TO_LENGTH$11 }, {
...
var USES_TO_LENGTH$12 = arrayMethodUsesToLength('some');

// `Array.prototype.some` method
// https://tc39.github.io/ecma262/#sec-array.prototype.some
_export({ target: 'Array', proto: true, forced: !STRICT_METHOD$7 || !USES_TO_LENGTH$12 }, {
...
var USES_TO_LENGTH$13 = arrayMethodUsesToLength('splice', { ACCESSORS: true, 0: 0, 1: 2 });
...
// with adding support of @@species
_export({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$3 || !USES_TO_LENGTH$13 }, {
...
if (PATCH) {
  patchedExec = function exec(str) {
    ...
    var flags$$1 = regexpFlags.call(re);
    var source = re.source;
    var charsAdded = 0;
    var strCopy = str;

    if (sticky) {
      flags$$1 = flags$$1.replace('y', '');
      if (flags$$1.indexOf('g') === -1) {
        flags$$1 += 'g';
      }
      ...
      // simulate the 'y' flag.
      reCopy = new RegExp('^(?:' + source + ')', flags$$1);
    }

    if (NPCG_INCLUDED) {
      reCopy = new RegExp('^' + source + '$(?!\\s)', flags$$1);
    }
...
_export({ target: 'Number', proto: true, forced: FORCED$10 }, {
...
_export({ target: 'Number', proto: true, forced: FORCED$11 }, {
...
_export({ target: 'Math', stat: true, forced: FORCED$12 }, {
...
_export({ target: 'Math', stat: true, forced: FORCED$13 }, {
...
_export({ target: 'Math', stat: true, forced: FORCED$14 }, {
...
_export({ target: 'Date', proto: true, forced: FORCED$15 }, {
  // eslint-disable-next-line no-unused-vars
...
if ($stringify$1) {
  ...
  _export({ target: 'JSON', stat: true, forced: FORCED$16 }, {
    // eslint-disable-next-line no-unused-vars
    stringify: function stringify(it, replacer, space) {
...
var newPromiseCapability$2 = newPromiseCapability.f;
...
var FORCED$17 = isForced_1(PROMISE, function () {
...
var INCORRECT_ITERATION$1 = FORCED$17 || !checkCorrectnessOfIteration(function (iterable) {
...
if (FORCED$17) {
  ...
  Internal.prototype = redefineAll(PromiseConstructor.prototype, {
    ...
    then: function then(onFulfilled, onRejected) {
      ...
      var reaction = newPromiseCapability$2(speciesConstructor(this, PromiseConstructor));
  ...
  newPromiseCapability.f = newPromiseCapability$2 = function (C) {
...
_export({ global: true, wrap: true, forced: FORCED$17 }, {
...
// statics
_export({ target: PROMISE, stat: true, forced: FORCED$17 }, {
...
_export({ target: PROMISE, stat: true, forced: isPure || FORCED$17 }, {
...
var defineProperty$10 = objectDefineProperty.f;
...
var addGetter = function (Constructor, key) {
  defineProperty$10(Constructor[PROTOTYPE$2], key, { get: function () { return getInternalState$6(this)[key]; } });
};
...
var defineProperty$11 = objectDefineProperty.f;
...
var NATIVE_ARRAY_BUFFER_VIEWS = arrayBufferNative && !!objectSetPrototypeOf && classof$1(global_1.opera) !== 'Opera';
...
var isTypedArray = function (it) {
  return isObject(it) && has(TypedArrayConstructorsList, classof$1(it));
};
...
if (descriptors && !has(TypedArrayPrototype, TO_STRING_TAG$3)) {
  ...
  defineProperty$11(TypedArrayPrototype, TO_STRING_TAG$3, { get: function () {
...
var aTypedArray$10 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$10 = arrayBufferViewCore.exportTypedArrayMethod;
...
var typedArrayValues = function values() {
  return arrayValues.call(aTypedArray$10(this));
};

// `%TypedArray%.prototype.entries` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.entries
exportTypedArrayMethod$10('entries', function entries() {
  return arrayEntries.call(aTypedArray$10(this));
});
// `%TypedArray%.prototype.keys` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.keys
exportTypedArrayMethod$10('keys', function keys() {
  return arrayKeys.call(aTypedArray$10(this));
});
// `%TypedArray%.prototype.values` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.values
exportTypedArrayMethod$10('values', typedArrayValues, !CORRECT_ITER_NAME);
// `%TypedArray%.prototype[@@iterator]` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype-@@iterator
exportTypedArrayMethod$10(ITERATOR$5, typedArrayValues, !CORRECT_ITER_NAME);

var aTypedArray$11 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$11 = arrayBufferViewCore.exportTypedArrayMethod;
var $join = [].join;

// `%TypedArray%.prototype.join` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.join
// eslint-disable-next-line no-unused-vars
exportTypedArrayMethod$11('join', function join(separator) {
  return $join.apply(aTypedArray$11(this), arguments);
});

var aTypedArray$12 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$12 = arrayBufferViewCore.exportTypedArrayMethod;

// `%TypedArray%.prototype.lastIndexOf` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.lastindexof
// eslint-disable-next-line no-unused-vars
exportTypedArrayMethod$12('lastIndexOf', function lastIndexOf(searchElement /* , fromIndex */) {
  return arrayLastIndexOf.apply(aTypedArray$12(this), arguments);
});

var $map$1 = arrayIteration.map;


var aTypedArray$13 = arrayBufferViewCore.aTypedArray;
var aTypedArrayConstructor$4 = arrayBufferViewCore.aTypedArrayConstructor;
var exportTypedArrayMethod$13 = arrayBufferViewCore.exportTypedArrayMethod;

// `%TypedArray%.prototype.map` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.map
exportTypedArrayMethod$13('map', function map(mapfn /* , thisArg */) {
  return $map$1(aTypedArray$13(this), mapfn, arguments.length > 1 ? arguments[1] : undefined, function (O, length) {
...
var aTypedArray$14 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$14 = arrayBufferViewCore.exportTypedArrayMethod;

// `%TypedArray%.prototype.reduce` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.reduce
exportTypedArrayMethod$14('reduce', function reduce(callbackfn /* , initialValue */) {
  return $reduce$1(aTypedArray$14(this), callbackfn, arguments.length, arguments.length > 1 ? arguments[1] : undefined);
});

var $reduceRight$1 = arrayReduce.right;

var aTypedArray$15 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$15 = arrayBufferViewCore.exportTypedArrayMethod;

// `%TypedArray%.prototype.reduceRicht` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.reduceright
exportTypedArrayMethod$15('reduceRight', function reduceRight(callbackfn /* , initialValue */) {
  return $reduceRight$1(aTypedArray$15(this), callbackfn, arguments.length, arguments.length > 1 ? arguments[1] : undefined);
});

var aTypedArray$16 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$16 = arrayBufferViewCore.exportTypedArrayMethod;
var floor$7 = Math.floor;

// `%TypedArray%.prototype.reverse` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.reverse
exportTypedArrayMethod$16('reverse', function reverse() {
  var that = this;
  var length = aTypedArray$16(that).length;
...
var aTypedArray$17 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$17 = arrayBufferViewCore.exportTypedArrayMethod;

var FORCED$18 = fails(function () {
  // eslint-disable-next-line no-undef
  new Int8Array(1).set({});
});
...
exportTypedArrayMethod$17('set', function set(arrayLike /* , offset */) {
  aTypedArray$17(this);
...
var aTypedArray$18 = arrayBufferViewCore.aTypedArray;
var aTypedArrayConstructor$5 = arrayBufferViewCore.aTypedArrayConstructor;
var exportTypedArrayMethod$18 = arrayBufferViewCore.exportTypedArrayMethod;
var $slice = [].slice;

var FORCED$19 = fails(function () {
  // eslint-disable-next-line no-undef
...
exportTypedArrayMethod$18('slice', function slice(start, end) {
  var list = $slice.call(aTypedArray$18(this), start, end);
  var C = speciesConstructor(this, this.constructor);
  var index = 0;
  var length = list.length;
...
var aTypedArray$19 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$19 = arrayBufferViewCore.exportTypedArrayMethod;

// `%TypedArray%.prototype.some` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.some
exportTypedArrayMethod$19('some', function some(callbackfn /* , thisArg */) {
  return $some$1(aTypedArray$19(this), callbackfn, arguments.length > 1 ? arguments[1] : undefined);
});

var aTypedArray$20 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$20 = arrayBufferViewCore.exportTypedArrayMethod;
var $sort = [].sort;

// `%TypedArray%.prototype.sort` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.sort
exportTypedArrayMethod$20('sort', function sort(comparefn) {
  return $sort.call(aTypedArray$20(this), comparefn);
});

var aTypedArray$21 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$21 = arrayBufferViewCore.exportTypedArrayMethod;

// `%TypedArray%.prototype.subarray` method
// https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.subarray
exportTypedArrayMethod$21('subarray', function subarray(begin, end) {
  var O = aTypedArray$21(this);
  var length = O.length;
...
var aTypedArray$22 = arrayBufferViewCore.aTypedArray;
var exportTypedArrayMethod$22 = arrayBufferViewCore.exportTypedArrayMethod;
...
exportTypedArrayMethod$22('toLocaleString', function toLocaleString() {
  return $toLocaleString.apply(TO_LOCALE_STRING_BUG ? $slice$1.call(aTypedArray$22(this)) : aTypedArray$22(this), arguments);
}, FORCED$20);

var exportTypedArrayMethod$23 = arrayBufferViewCore.exportTypedArrayMethod;
...
exportTypedArrayMethod$23('toString', arrayToString, IS_NOT_ARRAY_METHOD);
...
var FORCED$21 = NEW_TARGET_BUG || ARGS_BUG;

_export({ target: 'Reflect', stat: true, forced: FORCED$21, sham: FORCED$21 }, {
...
var FORCED$22 = !global_1.setImmediate || !global_1.clearImmediate;

// http://w3c.github.io/setImmediate/
_export({ global: true, bind: true, enumerable: true, forced: FORCED$22 }, {
  // `setImmediate` method
...
var setInternalState$10 = internalState.set;
...
var URLConstructor = function URL(url /* , base */) {
  ...
  var state = setInternalState$10(that, { type: 'URL' });
...
var __vue_render__ = function () {
  ...
  }), _vm._v(" "), _c("v-card-actions", [_c("v-spacer"), _vm._v(" "), Boolean(_vm.buttonTrueText) ? _c("v-btn", {
    attrs: {
  ...
  }, [_vm._v("\n        " + _vm._s(_vm.buttonTrueText) + "\n      ")]) : _vm._e(), _vm._v(" "), Boolean(_vm.buttonFalseText) ? _c("v-btn", {
    attrs: {
